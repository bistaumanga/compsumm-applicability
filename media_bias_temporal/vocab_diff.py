...
def run(df1, label1, label2, field):
    idx1 = np.where(df1.month == label1 )[0]
    idx2 = np.where(df1.month == label2 )[0]
...
def main():
    ...
    fp.write("topic,ideology,comp,n1,n2,units,vocab,jsd,cos,llr,top1,top2\n")
    ...
    for topic in ("guncontrol", "cbp01", "cbp02", "climatechange", "chr01"):
        ...
        for (label1, label2) in COMPS:
            ...
            msg = "{},{},{}_{},{},{},{},{},{:.6g},{:.6g},{:.6g},{},{}".format(
                TOPIC_MAP[topic], "all",
                MONTHS_MAP[label1], MONTHS_MAP[label2], n1t, n2t, 
            ...
            msg = "{},{},{}_{},{},{},{},{},{:.6g},{:.6g},{:.6g},{},{}".format(
                TOPIC_MAP[topic], "all",
                MONTHS_MAP[label1], MONTHS_MAP[label2], n1n, n2n, 
            ...
            # vocab, js, n1, n2 = run(df, label1, label2, field)
            # msg = "{},{},{}_{},{},{},{},{:.4g}".format(
            #     TOPIC_MAP[topic], "all",
            #     MONTHS_MAP[label1], MONTHS_MAP[label2], 
            #     vocab, n1, n2, js
            # )
            # logger.info(msg)
            # fp.write(msg + "\n")
        ...
        for ideology in IDEOLOGIES:
            ...
            for (label1, label2) in COMPS:
                ...
                # vocab, js, n1, n2 = run(df1, label1, label2, field)
                # msg = "{},{},{}_{},{},{},{},{:.4g}".format(
                #     TOPIC_MAP[topic], ideology,
                #     MONTHS_MAP[label1], MONTHS_MAP[label2], 
                #     vocab, n1, n2, js
